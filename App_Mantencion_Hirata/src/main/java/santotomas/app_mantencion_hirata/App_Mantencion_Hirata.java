package santotomas.app_mantencion_hirata;
import santotomas.gui.FramePrincipal;

/**
 * Clase principal de la App de mantencion Hirata
 * @authors Sebastián Pérez, Fabian Cares, Ayleen Martínez, Catherine Gomez
 * @version (2026.03.15 - 1.0)
 */
public class App_Mantencion_Hirata 
{
    /**
